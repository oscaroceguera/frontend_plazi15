...
},{"../chat/chat":2,"./template.jade":5,"jquery":11,"page":12}],5:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<section class=\"Layout\">   \t<section class=\"Layout-angonist\"> ");
// iterate [1,2,3,4,5]
;(function(){
  var $$obj = [1,2,3,4,5];
...
buf.push("<div class=\"Card\"><h2 class=\"Card-name\">Wolverine</h2><img src=\"./public/image/wolverine.jpg\" alt=\"Wolverine\" class=\"Card-image\"/><div class=\"Card-description\">Wolverine es muy poderoso</div><div class=\"Card-attack\">500 puntos de ataque</div></div>");
    }
...
text = "OMG ese ataque esuna mamada me quitaste muchos puntos"
...
buf.push("<div class=\"signin-container\"><label>Ingresa tu nombre</label><input type=\"text\" id=\"firstName\" name=\"firstName\" placeholder=\"oscar, david, etc\" tabindex=\"1\" class=\"Signin-name-input\"/><button tabindex=\"2\" class=\"Signin-button\">Comenzar</button></div>");;return buf.join("");
};
